...
{
    public class clsEncryptDescrypt
    {
        AES256 Objaec = new AES256();
        public string GetEncryptData(string data, string SecretKey)
        {
            var value = Objaec.Encrypt(data, SecretKey);
            return value;

        }
        public string GetDecryptData(string data, string SecretKey)
        {
            var value = Objaec.Decrypt(data, SecretKey);
            return value;
